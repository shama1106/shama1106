...
<!--
**shama1106/shama1106** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
...
![ETL Pipelines](https://img.shields.io/badge/ETL_Pipelines-4B8BBE?style=flat&logoColor=white)
![Data Warehousing](https://img.shields.io/badge/Data_Warehousing-1572B6?style=flat&logoColor=white)
![Kimball](https://img.shields.io/badge/Kimball_Methodology-0052CC?style=flat&logoColor=white)
...
### 🌏 [India vs China Market Analysis](https://github.com/shama1106/India-vs-China-Market-Analysis)
...
### 👟 [Digital Channel Analysis – Nike vs Adidas](https://github.com/shama1106/Digital-Channel-Analysis)
**`Python`** **`HTML`** **`Power BI`** **`Excel`**

Deep-dive into digital marketing channel performance for two global sportswear giants — data-backed comparison of engagement, conversion and channel ROI.
